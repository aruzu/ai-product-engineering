...
class TestAppBotClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = AppBotClient(username=self.test_username, password=self.test_password)
    ...
    @patch.dict(os.environ, {"APPBOT_API_USERNAME": "env_user", "APPBOT_API_PASSWORD": "env_pass"})
    ...
    def test_request(self, mock_request):
        ...
        result = self.client._request("test/endpoint", method="GET", params={"key": "value"})

        mock_request.assert_called_once_with(
            "GET", 
            "https://api.appbot.co/api/v2/test/endpoint", 
    ...
    def test_get_sentiment_breakdown(self, mock_request):
        ...
        result = self.client.get_sentiment_breakdown(app_id=123, start="2023-01-01", end="2023-01-31")
    ...
    def test_get_phrases(self, mock_request):
        mock_request.return_value = {
            "results": [
                {"phrase": "wonderful app", "counter": 1555, "positive": 1368}
            ],
            "count": 1
        }
